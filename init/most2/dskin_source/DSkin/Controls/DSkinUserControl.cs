namespace DSkin.Controls
{
    ...
    public class DSkinUserControl : UserControl, ILayered, IDuiContainer, IDuiDesigner, ILayeredContainer
    {
        ...
        private void jaIxFuiEgI(object sender, EventArgs e)
        {
        ...
        protected override void OnControlAdded(ControlEventArgs e)
        {
            ...
            if (!base.DesignMode)
            {
                ...
                e.Control.Move += new EventHandler(this.jaIxFuiEgI);
        ...
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content), Category("DSkin"), Description("DirectUI控件集合")]
        ...
        [Description("九宫格图片切割宽度"), Category("DSkin"), DefaultValue(typeof(Padding), "5,5,5,5")]
