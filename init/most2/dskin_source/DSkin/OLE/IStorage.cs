namespace DSkin.OLE
{
    ...
    {
        int CreateStream(string pwcsName, uint grfMode, uint reserved1, uint reserved2, out DSkin.OLE.IStream ppstm);
        int OpenStream(string pwcsName, IntPtr reserved1, uint grfMode, uint reserved2, out DSkin.OLE.IStream ppstm);
